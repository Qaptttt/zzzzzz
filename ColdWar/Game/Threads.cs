            ...
            while (true)
            {
                try
                {
                    ...
                    if (settings.InGame)
                    {
                        ...
                        if (settings.TP_ZM)
                        {
                            byte[] teleportBytes = new byte[]
                            {
                        184, 0, 0, 128, 63, 137, 129, 212, 2, 0, 0, 184, 0, 0, 128, 63,
                        137, 129, 216, 2, 0, 0, 184, 0, 0, 128, 63, 137, 129, 220, 2, 0, 0,
                        199, 129, 144, 3, 0, 0, 1, 0, 0, 0, 144, 144, 144, 144, 144, 144, 144,
                        144, 144, 144, 144, 144, 144, 144
                            };

                            memoryManager.WriteBytes(memoryManager.GameBase + Offsets.ZTeleport, teleportBytes, false);
                        ...
                        if (settings.cylce)
                        {
                            ...
                            if (playerShots >= 5 || num >= 1)
                            {
                                Form1.P1_CurrentKills = playerKills;
                ...
                {
                    Console.WriteLine($"Error in Update_Thread: {ex.Message}");
                }
